...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/uv@v5.0.0
      with:
        python-version: "3.14"
        allow-prereleases: false
        command: pytest
