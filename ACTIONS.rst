...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/coverage-combine-export@v5.2.0
      with:
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pipenv-run@v5.2.0
      with:
        command: pytest -q
        env: '{"PYTEST_ADDOPTS":"-ra"}'
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pipenv-setup@v5.2.0
      with:
        python-version: "3.14"
        allow-prereleases: false
        cache: true
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pipenv@v5.2.0
      with:
        python-version: "3.14"
        allow-prereleases: false
        command: pytest
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/uv-build@v5.2.0
      with:
        python-version: "3.14"
