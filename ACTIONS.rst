...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/coverage-combine-export@v4.4.6
      with:
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pip@v4.4.6
      with:
        python-version: "3.14"
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pipenv-run@v4.4.6
      with:
        command: pytest -q
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pipenv-setup@v4.4.6
      with:
        python-version: "3.14"
        allow-prereleases: false
        cache: true
...
.. code-block:: yaml
    ...
    - uses: fizyk/actions-reuse/.github/actions/pipenv@v4.4.6
      with:
        python-version: "3.14"
        allow-prereleases: false
        command: pytest
