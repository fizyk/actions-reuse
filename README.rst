...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/pypi.yml@v2.4.6
...
.. code-block:: yaml
    ...
    jobs:
      lint:
        uses: fizyk/actions-reuse/.github/workflows/linters-python.yml@v2.4.6
...
.. code-block:: yaml
    ...
    jobs:
      tests:
        uses: fizyk/actions-reuse/.github/workflows/tests-pytests.yml@v2.4.6
...
.. code-block:: yaml
    ...
    jobs:
      automerge:
        uses: fizyk/actions-reuse/.github/workflows/automerge-shared.yml@v2.4.6
