...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/shared-pr-check.yml@v4.4.4
...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/shared-pypi.yml@v4.4.4
...
.. code-block:: yaml
    ...
    jobs:
      tests:
        uses: fizyk/actions-reuse/.github/workflows/shared-tests-pytests.yml@v4.4.4
...
.. code-block:: yaml
    ...
    jobs:
      diagrams:
        ...
        permissions:
          contents: write
        uses: fizyk/actions-reuse/.github/workflows/shared-diagrams.yml@v4.4.4
...
.. code-block:: yaml
    ...
    jobs:
      automerge:
        uses: fizyk/actions-reuse/.github/workflows/shared-automerge.yml@v4.4.4
...
.. code-block:: yaml
    ...
    jobs:
      release:
        permissions:
          contents: write
        uses: fizyk/actions-reuse/.github/workflows/shared-release.yml@v4.4.4
        with:
