...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/shared-pr-check.yml@v5.1.2
...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/shared-pypi.yml@v5.1.2
...
.. code-block:: yaml
    ...
    jobs:
      tests:
        uses: fizyk/actions-reuse/.github/workflows/shared-tests-pytests.yml@v5.1.2
...
.. code-block:: yaml
    ...
    jobs:
      diagrams:
        ...
        permissions:
          contents: write
        uses: fizyk/actions-reuse/.github/workflows/shared-diagrams.yml@v5.1.2
...
.. code-block:: yaml
    ...
    jobs:
      automerge:
        uses: fizyk/actions-reuse/.github/workflows/shared-automerge.yml@v5.1.2
...
.. code-block:: yaml
    ...
    jobs:
      release:
        permissions:
          contents: write
        uses: fizyk/actions-reuse/.github/workflows/shared-release.yml@v5.1.2
        with:
