...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/shared-pr-check.yml@v3.0.0
...
.. code-block:: yaml
    ...
    jobs:
      build:
        uses: fizyk/actions-reuse/.github/workflows/shared-pypi.yml@v3.0.0
...
.. code-block:: yaml
    ...
    jobs:
      lint:
        uses: fizyk/actions-reuse/.github/workflows/shared-linters-python.yml@v3.0.0
...
.. code-block:: yaml
    ...
    jobs:
      tests:
        uses: fizyk/actions-reuse/.github/workflows/shared-tests-pytests.yml@v3.0.0
...
.. code-block:: yaml
    ...
    jobs:
      automerge:
        uses: fizyk/actions-reuse/.github/workflows/shared-automerge.yml@v3.0.0
